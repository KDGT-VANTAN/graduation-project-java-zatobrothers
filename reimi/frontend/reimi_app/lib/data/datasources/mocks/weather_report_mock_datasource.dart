...
class WeatherReportMockDataSource implements WeatherReportRemoteDataSource {
  ...
  @override
  Future<WeatherReportDetailDto?> fetchWeatherReport(String reportId) async {
    for (final weatherReport in mockWeatherReportDetails) {
      if (weatherReport.id == reportId) {
...
final List<WeatherReportDto> mockWeatherReports = [
  WeatherReportDto(
    id: 'report_001',
...
final List<WeatherReportDetailDto> mockWeatherReportDetails = [
  WeatherReportDetailDto(
    id: 'report_001',
    userId: 'chat_user_001',
    userName: 'さくら',
    mainPhotoUrl: Assets.images.sample.chatUser001SampleImage.path,
    comment: '今日は雲一つない快晴！とても気持ちが良いです。',
    weatherType: WeatherType.clearStars,
  ...
  WeatherReportDetailDto(
    ...
    comment: '入道雲が出てきました。夏本番という感じですね。',
    weatherType: WeatherType.noStars,
