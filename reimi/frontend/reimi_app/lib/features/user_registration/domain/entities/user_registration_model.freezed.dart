...
mixin _$UserRegistrationModel {
 ...
 Gender? get gender; DateTime? get birthDate; Address? get address; String? get name; String? get introduction; String? get mainPhotoUrl;
...
@useResult
$Res call({
 Gender? gender, DateTime? birthDate, Address? address, String? name, String? introduction, String? mainPhotoUrl
});
...
/// Create a copy of UserRegistrationModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? gender = freezed,Object? birthDate = freezed,Object? address = freezed,Object? name = freezed,Object? introduction = freezed,Object? mainPhotoUrl = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Gender? gender,  DateTime? birthDate,  Address? address,  String? name,  String? introduction,  String? mainPhotoUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserRegistrationModel() when $default != null:
return $default(_that.gender,_that.birthDate,_that.address,_that.name,_that.introduction,_that.mainPhotoUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Gender? gender,  DateTime? birthDate,  Address? address,  String? name,  String? introduction,  String? mainPhotoUrl)  $default,) {final _that = this;
switch (_that) {
case _UserRegistrationModel():
return $default(_that.gender,_that.birthDate,_that.address,_that.name,_that.introduction,_that.mainPhotoUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Gender? gender,  DateTime? birthDate,  Address? address,  String? name,  String? introduction,  String? mainPhotoUrl)?  $default,) {final _that = this;
switch (_that) {
case _UserRegistrationModel() when $default != null:
return $default(_that.gender,_that.birthDate,_that.address,_that.name,_that.introduction,_that.mainPhotoUrl);case _:
  return null;
...
class _UserRegistrationModel implements UserRegistrationModel {
  const _UserRegistrationModel({this.gender, this.birthDate, this.address, this.name, this.introduction, this.mainPhotoUrl});
...
@override final  String? mainPhotoUrl;
...
/// Create a copy of UserRegistrationModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? gender = freezed,Object? birthDate = freezed,Object? address = freezed,Object? name = freezed,Object? introduction = freezed,Object? mainPhotoUrl = freezed,}) {
