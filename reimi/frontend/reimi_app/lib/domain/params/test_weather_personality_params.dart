...
part 'test_weather_personality_params.freezed.dart';

@freezed
abstract class TestWeatherPersonalityParams
    with _$TestWeatherPersonalityParams {
  const factory TestWeatherPersonalityParams({
