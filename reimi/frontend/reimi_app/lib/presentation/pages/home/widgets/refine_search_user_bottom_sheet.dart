...
void refineSearchUserBottomSheet({
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      t.bottomSheet.refineSearchUser.title,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    _SectionTitle(t.bottomSheet.refineSearchUser.section.age),
                    Text(
                ...
                _SectionTitle(t.bottomSheet.refineSearchUser.section.address),
                const SizedBox(height: 8),
                Flexible(
                ...
                const SizedBox(height: 20),
                _SectionTitle(t.bottomSheet.refineSearchUser.section.gender),
                const SizedBox(height: 8),
                Wrap(
                  spacing: 8,
                  runSpacing: 8,
                ...
                const SizedBox(height: 20),
                _SectionTitle(
                    t.bottomSheet.refineSearchUser.section.weatherPersonality),
                const SizedBox(height: 8),
                const Flexible(
                  child: SingleChildScrollView(
                    scrollDirection: Axis.horizontal,
