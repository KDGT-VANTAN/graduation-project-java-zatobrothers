...
part 'user_with_profile_dto.freezed.dart';
part 'user_with_profile_dto.g.dart';

@freezed
abstract class UserWithProfileDto with _$UserWithProfileDto {
  const factory UserWithProfileDto({
    required String id,
