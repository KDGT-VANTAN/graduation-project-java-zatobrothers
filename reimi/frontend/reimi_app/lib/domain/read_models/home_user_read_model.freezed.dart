...
mixin _$HomeUserReadModel {
  ...
  @override
  String toString() {
    return 'HomeUserReadModel(id: $id, name: $name, birthDate: $birthDate, address: $address, mainPhotoUrl: $mainPhotoUrl, introduction: $introduction, isTodayReported: $isTodayReported)';
  }
}
