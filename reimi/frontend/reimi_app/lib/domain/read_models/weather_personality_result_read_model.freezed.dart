...
mixin _$WeatherPersonalityResultReadModel {
  ...
  /// Serializes this WeatherPersonalityResultReadModel to a JSON map.
  ...
  @override
  String toString() {
    return 'WeatherPersonalityResultReadModel(typeCode: $typeCode, typeName: $typeName, typeCatchphrase: $typeCatchphrase, typeCharacterImageUrl: $typeCharacterImageUrl, rulingStatement: $rulingStatement, axisFeatures: $axisFeatures, axisScore: $axisScore, behaviorTendencyList: $behaviorTendencyList, godsMessage: $godsMessage)';
  }
}
...
class _WeatherPersonalityResultReadModel
  ...
  factory _WeatherPersonalityResultReadModel.fromJson(
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$WeatherPersonalityResultReadModelToJson(
      this,
    );
  }
